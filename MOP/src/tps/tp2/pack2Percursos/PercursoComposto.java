...
public class PercursoComposto {
	...
	public PercursoComposto(String nome, PercursoSimples[] percursos,
		...
		for (int i = 0; i < percursos.length-1; i++) {
			if ((percursos[i] == null) || (percursos[i].getFim() != percursos[i + 1].getInicio()))
				throw new IllegalArgumentException(
						"Array de percursos inválido -> " + percursos);
		}
		this.nome = nome;
	...
	public String getFim() {
		return percursos[nPercursos].getFim();
	}
	...
	public String toString() {
		return nome + " de " + this.getInicio() + " para " + this.getFim()
				+ " com " + this.getDistancia() + " metros , com "
				+ this.getDeclive() + " e com " + " percursos";
	}
