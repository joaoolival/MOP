...
public class P05Xadrez {
	...
	public static void main(String[] args) {
		...
		// ciclo para verificar se o bispo nao esta a ser atacado pela torre
		while (!bispo1) {
		...
		while (!bispo2) {
			// neste caso e avaliado se o Bispo2 esta a ser atacado pela Torre1
			// e pelo Bispo1
		...
		while (!torre2) {
			// neste caso e avaliado se a Torre2 esta a ser atacada pela Torre1
