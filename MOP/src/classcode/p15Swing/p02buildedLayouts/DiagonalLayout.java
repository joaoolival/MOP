...
/** 
 * ATENÇÃo: este é um exemplo de um layout manager construído.
 *  Nós em MoP não estamos interessados em construir layout managers
 *  Está presenta apenas para se ter uma percepção de que se poderia
